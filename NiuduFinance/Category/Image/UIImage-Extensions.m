...
- (UIImage *)imageMakeRoundCornerSizeImageView:(UIImageView *)imageView
{
    ...
    UIBezierPath *path = [UIBezierPath bezierPathWithOvalInRect:contentRect];
    [path addClip];
...
- (UIImage *)imageMakeRoundCornerSize:(CGSize)size
{
    CGRect contentRect = CGRectMake(0, 0, size.width, size.height);
