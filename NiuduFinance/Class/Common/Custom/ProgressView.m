...
- (void)addArcBackColor{
    ...
    CGColorRef color = (_arcBackColor == nil) ? [UIColor colorWithHexString:@"#efefef"].CGColor : _arcBackColor.CGColor;
//    CGColorRef color = (_arcFinishColor == nil) ? [UIColor whiteColor].CGColor : _arcFinishColor.CGColor;
...
- (void)drawArc{
    ...
    if (_percent == 1) {
        ...
        CGColorRef color = (_arcUnfinishColor == nil) ? [UIColor whiteColor].CGColor : _arcUnfinishColor.CGColor;
        ...
        CGContextAddArc(contextRef, center.x, center.y, radius,270*(M_PI/180),endAngle + 270*(M_PI/180), 0);
...
- (void)addCenterLabel{
    ...
    if (_percent == 1) {
        ...
        arcColor = (_arcFinishColor == nil) ? [UIColor whiteColor] : _arcFinishColor;
...
//    [percent drawInRect:CGRectMake(5, (viewSize.height-fontSize + 15)/2, viewSize.width-10, fontSize)withAttributes:attributes];
