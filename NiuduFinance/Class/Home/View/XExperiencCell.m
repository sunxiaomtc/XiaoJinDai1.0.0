...
- (void)setuptitle:(NSString *)title tulabel:(NSString *)tulabel imgeView:(BOOL )imgeView castLabel:(NSString *)castLabel lineView:(BOOL)lineView annual:(NSString *)annual annualNum:(NSString *)annualNum percent:(NSString *)percent timeLimit:(NSString *)timeLimit timeLimitNum:(NSString *)timeLimitNum timeLabel:(NSString *)timeLabel touLabl:(NSString *)touLabl remain:(NSString *)remain progressLabel:(NSString *)progressLabel;
{
    ...
    [_projectTitleNewLab setFont:[UIFont systemFontOfSize:13]];
    [_projectTitleNewLab setTextColor:[UIColor colorWithHexString:@"#A9A9A9"]];
    ...
    [_annual mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.centerX.equalTo(self.contentView.mas_left).with.offset(SCREEN_WIDTH/8*2);
    ...
    [_timeLimit mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(77);
        make.height.mas_equalTo(13);
        make.centerX.equalTo(self.contentView.mas_left).with.offset(SCREEN_WIDTH/8*4);
    }];
    ...
    [_progressLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(77);
        make.height.mas_equalTo(13);
        make.centerX.equalTo(self.contentView.mas_left).with.offset(SCREEN_WIDTH/8*6);
    }];
    
    [_castLabel setFont:[UIFont systemFontOfSize:13]];
    [_castLabel setTextColor:[UIColor colorWithHexString:@"#019BFF"]];
    [self.contentView addSubview:_castLabel];
    [_castLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.equalTo(_annualNum.mas_bottom);
        make.height.mas_equalTo(13);
        make.centerX.equalTo(_progressLabel.mas_centerX);
    }];
    
    
    [_timeLimitNum setTextColor:[UIColor orangeColor]];
    [_timeLimitNum setFont:[UIFont systemFontOfSize:25]];
    ...
    _touLabl.layer.cornerRadius = 16.0f;
    _touLabl.clipsToBounds = YES;
    [_touLabl.layer setBorderWidth:1];
    _touLabl.layer.borderColor = [UIColor colorWithHexString:@"#019BFF"].CGColor;
    _touLabl.textAlignment = NSTextAlignmentCenter;
    [_touLabl setTextColor:[UIColor colorWithHexString:@"#019BFF"]];
    [_touLabl setBackgroundColor:[UIColor whiteColor]];
    [_touLabl setFont:[UIFont systemFontOfSize:14]];
    [self.contentView addSubview:_touLabl];
    [_touLabl mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.timeLimit.mas_bottom).with.offset(20);
