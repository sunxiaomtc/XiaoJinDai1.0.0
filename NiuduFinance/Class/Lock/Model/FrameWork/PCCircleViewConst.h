 ...
 *  重新绘制提示字的颜色
 */
#define AgainTextColorNormalState rgba(240,150,107,1)
/**
 *  单个圆背景色
 */
 ...
 *  解锁背景色
 */
#define CircleViewBackgroundColor rgba(231,229,236,1)

/**
 *  普通状态下外空心圆颜色
 */
#define CircleStateNormalOutsideColor rgba(247,247,247,1)

/**
 *  选中状态下外空心圆颜色
 */
#define CircleStateSelectedOutsideColor rgba(107,210,251,1)

/**
 *  错误状态下外空心圆颜色
 */
#define CircleStateErrorOutsideColor rgba(230,47,57,1)

/**
 *  普通状态下内实心圆颜色
 */
#define CircleStateNormalInsideColor rgba(247,247,247,1)

/**
 *  选中状态下内实心圆颜色
 */
#define CircleStateSelectedInsideColor rgba(107,210,251,1)

/**
 *  错误状态内实心圆颜色
 */
#define CircleStateErrorInsideColor rgba(230,47,57,1)
 ...
 *  错误状态三角形颜色
 */
#define CircleStateErrorTrangleColor rgba(230,47,57,1)
 ...
 *  普通时连线颜色
 */
#define CircleConnectLineNormalColor rgba(107,210,251,1)

/**
 *  错误时连线颜色
 */
#define CircleConnectLineErrorColor rgba(230,47,57,1)

/**
 *  连线宽度
 */
#define CircleConnectLineWidth 3.0f
 ...
 *  内部实心圆占空心圆的比例系数
 */
#define CircleRadio 0.3

/**
 *  整个解锁View居中时，距离屏幕左边和右边的距离
 */
#define CircleViewEdgeMargin 25.0f
 ...
 *  普通状态下文字提示的颜色
 */
#define textColorNormalState rgba(247,247,247,1)
 ...
 *  确认图案，提示再次绘制
 */
#define gestureTextDrawAgain @"请再次绘制解锁密码"
 ...
 *  请输入原手势密码
 */
#define gestureTextLoginGesture @"请输入手势密码"
