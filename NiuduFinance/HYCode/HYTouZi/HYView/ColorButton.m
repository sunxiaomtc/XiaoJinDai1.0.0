...
-(void)setCustomColorArray:(NSMutableArray *)colorArray byType:(GradientType)type
{
    UIImage *backImage = [self buttonImageFromColors:colorArray ByGradientType:type];
    [self setBackgroundImage:backImage forState:UIControlStateNormal];
}
