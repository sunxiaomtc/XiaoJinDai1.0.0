...
//加入圆弧layer
-(void)makeCircle:(CGFloat)percent withAnimationTime:(CGFloat)animationTime{
...
-(void)addCircle{
    ...
    if(!self.animtionLayer){
        ...
        self.animtionLayer.strokeColor = [UIColor colorWithHexString:@"#F5635D"].CGColor;
        self.animtionLayer.lineWidth = 2;
