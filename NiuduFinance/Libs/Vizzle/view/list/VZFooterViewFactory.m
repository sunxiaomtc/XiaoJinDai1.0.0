...
+ (UIView *)clickableFooterView:(CGRect)frame Text:(NSString*)text Target:(id)target Action:(SEL)action
{
    ...
    [btn setTitleColor:[UIColor colorWithWhite:0.7 alpha:0.95] forState:UIControlStateNormal];
...
+ (UIView *)loadingFooterView:(CGRect)frame Text:(NSString *)text
{
    ...
    CGSize textSize            = [text sizeWithAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:14.f]}];
    // Initialization code.
